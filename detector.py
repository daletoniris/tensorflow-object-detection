...
PATH_TO_LABELS = os.path.join(CWD_PATH,'configuracion','label_map.pbtxt')
...
def pet_detector(frame):
    ...
    cv2.putText(frame,"",(TL_outside[0]+10,TL_outside[1]-10),font,1,(255,20,255),3,cv2.LINE_AA)
    cv2.rectangle(frame,TL_inside,BR_inside,(20,20,255),3)
    cv2.putText(frame,"",(TL_inside[0]+10,TL_inside[1]-10),font,1,(20,255,255),3,cv2.LINE_AA)
    ...
    # and send a text to the phone.
     ...
     #   detected_inside = True
        ...
        #os.system("ssh pi@192.168.1.102 python3 /home/pi/robot4.py")
        #comando11=" google_speech -l es 'persona detectada' -e speed 1 pitch -600"
    ...
    if outside_counter > 4:
        ...
        pause = 1
    if  int(classes[0][0]) == 2 and (pause == 0):
    ...
    if  int(classes[0][0]) == 2 and (pause == 0):
        ...
        #os.system("ssh pi@192.168.1.102 python3 /home/pi/robotstop.py")
        comando11="ssh pi@192.168.0.132 python3 /home/pi/robotstop.py"
        resultado11 = subprocess.Popen(comando11, 
                               shell=True, 
                               stdout=subprocess.PIPE)
        
        time.sleep(5)
        comando12="ssh pi@192.168.0.132 python3 /home/pi/robot4.py"
        resultado11 = subprocess.Popen(comando12, 
                               shell=True, 
                               stdout=subprocess.PIPE)
    ...
    # Draw counter info
    cv2.putText(frame,'  ' + str(max(inside_counter,outside_counter)),(10,100),font,0.5,(255,255,0),1,cv2.LINE_AA)
    cv2.putText(frame,' ' + str(pause_counter),(10,150),font,0.5,(255,255,0),1,cv2.LINE_AA)
